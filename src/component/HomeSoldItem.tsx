...
const HomeSoldItem = () => {
   ...
   <RevealCompnenet>      <Card.Title className="d-flex justify-content-space-between align-items-baseline">
          ...
          <RevealCompnenet> <span className="fs-2 special-title">{ItemSold.name}</span>  </RevealCompnenet>  
          <RevealCompnenet> <span className="ms-2"> {ItemSold.price} $ </span>  </RevealCompnenet>  
        </Card.Title> </RevealCompnenet>
       

      </Card.Body>
      <Button variant="#DAA520"  className="fs-4" style={{ background : '#DAA520' , width: '100%'}}> GET NOW ! </Button>
