...
import Camera2 from '../../public/images/parallax/camera2.png';
import '../index.scss'
   ...
   <div className='blob-wrapper'> 
    ...
    <svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="100%" id="blobSvg">
        <defs>
          ...
          <stop offset="0%" style={{ stopColor: 'rgb(218, 165, 32)' }}></stop>
            <stop offset="100%" style={{ stopColor: 'rgb(1, 3, 25,0.5)' }}></stop>
          </linearGradient>
          </defs>
          <path id="blobPath" fill="url(#gradient)">
            <animate
              attributeName="d"
              dur="10000ms"
...
<svg viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="100%" id="blobSvg">
        <defs>
          <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" style={{ stopColor: 'rgb(1, 3, 25,0.2)' }}></stop>
            <stop offset="100%" style={{ stopColor: 'rgb(1, 3, 25,0.5)' }}></stop>
          </linearGradient>
          </defs>
          <path id="blobPath" fill="url(#gradient)">
...
<div className="camera_blob"> <img src={Camera2} alt="" /></div>
<div className="main-titles">
<h1>Empower Your Visual Voice</h1>
<h1>Start your Journey Through the Lens</h1>
<h1>By Revealing the World One Shot at a Time</h1>
</div>
